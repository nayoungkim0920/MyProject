...
void ImageProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->imageProcessed((*reinterpret_cast< std::add_pointer_t<QList<ImageProcessor::ProcessingResult>>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageProcessor::*)(QVector<ImageProcessor::ProcessingResult> );
...
// SIGNAL 0
void ImageProcessor::imageProcessed(QVector<ImageProcessor::ProcessingResult> _t1)
{
